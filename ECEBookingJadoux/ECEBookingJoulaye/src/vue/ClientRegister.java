...
public class ClientRegister extends javax.swing.JFrame {
    ...
    private Client C1;
    private JFrame notrePage;

    /**
     * Creates new form EmployeeRegister
     */
    public ClientRegister(Client client, PageRecherche lapage) {
        setTitle("LogECE.fr");
        setSize(1000, 500);
        //pour fermer proprement la fenêtre en vliquant sur la croix
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        client = C1;
        lapage = (PageRecherche) notrePage;
        connexion();
    }
    public ClientRegister(Client client, PageResultats lapage) {
        setTitle("LogECE.fr");
        setSize(1000, 500);
        //pour fermer proprement la fenêtre en vliquant sur la croix
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        client = C1;
        lapage = (PageResultats) notrePage;
        connexion();
    }
    public ClientRegister(Client client, PageDescription lapage) {
        setTitle("LogECE.fr");
        setSize(1000, 500);
        //pour fermer proprement la fenêtre en vliquant sur la croix
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        client = C1;
        lapage = (PageDescription) notrePage;
        connexion();
    }
    public ClientRegister(Client client, Hebergement hebergement, Reservation reservation) {
        setTitle("LogECE.fr");
        setSize(1000, 500);
        //pour fermer proprement la fenêtre en vliquant sur la croix
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            try {
                ...
                if (cliDao.searchClient(C1)) {
                    ...
                    new PageReserv(hebergement, C1, reservation);
                    dispose();
                } else {
                    panneau.remove(ls);
...
/*
                ...
                new PageResultats("", C1).setC1(C1);
                notrePage(notrePage.getHeberg(), C1).setC1(C1);
*/
                dispose();
            } else {
                panneau.remove(ls);
